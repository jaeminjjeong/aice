...
## Chapter 7. [실습] 공공자전거 수요 예측
## Chapter 8. [실습] 야구게임 타자 등급 분류
...
GPT AI로 소프트웨어 만들어서 가족/친구/고객에게 공유해보기

## Chapter 3. [이론] AI 구현 프로세스
## Chapter 4. [실습] 음원 흥행 가능성 예측
## Chapter 5. [실습] 중공업 수주 여부 예측 
## Chapter 6. [실습] 항공사 고객만족 예측
## Chapter 7. [실습] (회귀) 미세먼지 수치 예측
...
## Chapter 4. [이론+실습] Python을 활용한 AI 모델링 
## Chapter 5. [실습] (분류) 악성사이트 탐지 모델링 
## Chapter 6. [실습] (분류) 고객 가입유형 에측
## Chapter 7. [실습] (회귀) 공기질 데이터 기반 미세먼지 예측
